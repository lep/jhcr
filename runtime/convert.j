...
set toType = _toTypeOffset [toType]
if (toType < 5) then
if (toType < 3) then
if (toType < 2) then
if (fromType < 47) then
...
set _toTypeOffset [1] = 1
set _toTypeOffset [36] = 2
set _toTypeOffset [42] = 3
set _toTypeOffset [58] = 4
set _toTypeOffset [59] = 5
set _toTypeOffset [88] = 6
set _toTypeOffset [91] = 7
set _toTypeOffset [93] = 8
endfunction